...
* Spring 6:
* Spring Boot 3:
  * Spring Data REST (no controller/svc layer) - [Article](https://medium.com/@mertkagan/spring-data-rest-say-goodbye-to-controller-and-service-1acb6c7437f1) : [code](src/main/java/com/jrsmth/cardinal/fittrack/week/model/WeekRepository.java)
* Java 21:
